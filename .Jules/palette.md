...
## 2026-05-22 - Visual Hierarchy via Mermaid Diagrams
**Learning:** For orchestration-focused repositories, high-level architecture diagrams provide immediate cognitive relief. Using Mermaid 'style' definitions and subgraphs helps establish a clear visual hierarchy between Cloud Native, Orchestration, and Infrastructure layers.

**Action:** Use Mermaid diagrams in the `README.md` for infrastructure projects to visually represent orchestration layers. Apply distinct styles (e.g., `fill:#f96`) to highlight the primary system core.
